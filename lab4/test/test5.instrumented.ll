...
if.end:                                           ; preds = %if.then, %while.body
  call void @__coverage__(i32 14, i32 9)
  %1 = load i32, i32* %j, align 4, !dbg !34
  call void @__coverage__(i32 14, i32 11)
  %cmp2 = icmp eq i32 %1, 1, !dbg !36
  call void @__coverage__(i32 14, i32 16)
  br i1 %cmp2, label %land.lhs.true, label %if.end5, !dbg !37

land.lhs.true:                                    ; preds = %if.end
  call void @__coverage__(i32 14, i32 19)
  %2 = load i32, i32* %i, align 4, !dbg !38
  call void @__coverage__(i32 14, i32 21)
  %cmp3 = icmp eq i32 %2, 120, !dbg !39
  call void @__coverage__(i32 14, i32 9)
  br i1 %cmp3, label %if.then4, label %if.end5, !dbg !40

if.then4:                                         ; preds = %land.lhs.true
  call void @__coverage__(i32 15, i32 11)
  %3 = load i32, i32* %y, align 4, !dbg !41
  call void @__coverage__(i32 15, i32 15)
  %4 = load i32, i32* %x, align 4, !dbg !43
  call void @__sanitize__(i32 %4, i32 15, i32 13)
  call void @__coverage__(i32 15, i32 13)
  %div = sdiv i32 %3, %4, !dbg !44
  call void @__coverage__(i32 15, i32 9)
  store i32 %div, i32* %z, align 4, !dbg !45
  call void @__coverage__(i32 16, i32 5)
...
while.end:                                        ; preds = %while.cond
  call void @__coverage__(i32 18, i32 3)
  ret i32 0, !dbg !49
}
